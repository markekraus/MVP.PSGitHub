#
# Module manifest for module 'MVP.PSGitHub'
#
...
@{
    ...
    GUID              = '80d06e4e-cff2-48b0-9efe-989e4d6fd750'

    # Author of this module
    Author            = 'Mark Kraus'

    # Company or vendor of this module
    CompanyName       = 'markekraus'

    # Copyright statement for this module
    Copyright         = 'Copyright (c) Mark Kraus. All rights reserved.'

    # Description of the functionality provided by this module
    Description       = 'Utility Functions for Adding PowerShell GitHub Contributions to the Microsoft MVP API'
